...
Polyseum is being created with a 20-person team in C++ using Unreal Engine 4.

### Programming Contributions

- Architecting the in-game chat system
- Adding on to our status effect system
...
- Handling reconnecting to the game while maintaining player stats
- Dash formula
