...
#content p, #content ul, #content ol, .widget-area, .widget-area a { line-height:<?php echo $tempera_lineheight ?>; } 
...
<?php switch ($tempera_menualign): 
		case "center": ?> #access > .menu > ul { display: table; margin: 0 auto; text-align: center; } 
						  ...
						  #access > .menu > ul { border-left: 1px solid <?php echo cryout_hexadder($tempera_menucolorbgdefault,'24');?>; 
