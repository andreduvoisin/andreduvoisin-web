...
// Edits from original frontpage.php are prefaced with: ANDRE_CHANGED
...
// ANDRE_CHANGED: Copy/pasted this line from bottom of file.
// Moves the text area (front-text3) up below the title.
...
// ANDRE_CHANGED: Commented out this line (and copy/pasted further up in file).
/*if($parabola_fronttext3) {?><div id="front-text3"> <blockquote><?php echo do_shortcode($parabola_fronttext3) ?> </blockquote></div><?php }*/
